...
public class WBDialog extends Dialog {
    ...
    public void initDatabase(TweetNote tn) {
    ...
    public boolean openDialogDate() {
        ((RecordActivity) mContext).showDialog(contentView);
...
//        initDatabase(mWb);
    ...
    public static class Builder {
        ...
        public WBDialog create() {
            ...
            //menu.findViewById(R.id.date_value);
            // set the content message
//            if (message != null) {
//                ((TextView) menu.findViewById(R.id.nextscore)).setText(message);
//            } else if (contentView != null) {
//                // if no message set
//                // add the contentView to the dialog body
//                ((LinearLayout) menu.findViewById(R.id.content))
//                        .removeAllViews();
//                ((LinearLayout) menu.findViewById(R.id.content))
