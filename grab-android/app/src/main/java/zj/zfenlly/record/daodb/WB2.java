package zj.zfenlly.record.daodb;
...
public class WB2 {
    ...
    @Generated(hash = 1872346464)
    public WB2(Long id, @NotNull String totalscore, String nextscore, String date) {
        this.id = id;
